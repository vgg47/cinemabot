...
# PUBLIC
async def search(query, session, pages=1, lang='ru', ncr=False, void=True, time_period=False, sort_by_date=False, first_page=0):
    ...
    for i in range(first_page, first_page + pages):
        url = _get_search_url(query, i, lang=lang,  ncr=ncr, time_period=time_period, sort_by_date=sort_by_date)
